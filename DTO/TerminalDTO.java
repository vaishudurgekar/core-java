public class TerminalDTO {
	 ...
	 @Override
	  public String toString(){
        return "[Patient : id = "this.getId()+",Name="+this.getName()+",NoOfLoadingBridges="+this.getoOfLoadingBridges()+",NoOfDepartureGates="+this.getNoOfDepartureGates()+",NoOfCheckIncounters="+this.getNoOfCheckIncounters()+"]" ;
      }
